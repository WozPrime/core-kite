                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                ...
                                @else
                                    <img src="{{ url('pp/' . $data_user->pp) }}" class="profile-user-img img-fluid img-circle">
                                @endif
                            </div>
                                ...
                                <div class="active tab-pane" id="bio">
                                    ...
                                    <p class="text-muted">
                                        @if ($data_user->stats == "KM")
                                                Karyawan Magang
                                                @elseif($data_user->stats == "KT")Karyawan Tetap @endif
                                    </p>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <select name="gender" id="gender" class="form-control">
                                                            ...
                                                            <option value="L" @if ($data_user->gender == 'L') selected @endif>Laki-laki
                                                            </option>
                                                            <option value="P" @if ($data_user->gender == 'P') selected @endif>Perempuan
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <select name="stats" id="stats" class="form-control">
                                                            <option value="" @if ($data_user->stats == '') selected @endif disabled hidden>
                                                                Pilih Status
                                                            </option>
                                                            <option value="KT" @if ($data_user->stats == 'KT') selected @endif>Karyawan Tetap
                                                            </option>
                                                            <option value="KM" @if ($data_user->stats == 'KM') selected @endif>Karyawan Magang
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group row">
