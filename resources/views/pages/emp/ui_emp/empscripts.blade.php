...
<script src="{{ secure_asset('assetemp/js/vendor/jquery-2.2.4.min.js') }}"></script>
<!-- bootstrap 4 js -->
<script src="{{ secure_asset('assetemp/js/popper.min.js') }}"></script>
<script src="{{ secure_asset('assetemp/js/bootstrap.min.js') }}"></script>
<script src="{{ secure_asset('assetemp/js/owl.carousel.min.js') }}"></script>
<script src="{{ secure_asset('assetemp/js/metisMenu.min.js') }}"></script>
<script src="{{ secure_asset('assetemp/js/jquery.slimscroll.min.js') }}"></script>
<script src="{{ secure_asset('assetemp/js/jquery.slicknav.min.js') }}"></script>
...
<script src="{{ secure_asset('assetemp/js/line-chart.js') }}"></script>
<!-- all pie chart -->
<script src="{{ secure_asset('assetemp/js/pie-chart.js') }}"></script>
<!-- all bar chart -->
<script src="{{ secure_asset('assetemp/js/bar-chart.js') }}"></script>
<!-- all map chart -->
<script src="{{ secure_asset('assetemp/js/maps.js') }}"></script>
<!-- others plugins -->
<script src="{{ secure_asset('assetemp/js/plugins.js') }}"></script>
<script src="{{ secure_asset('assetemp/js/scripts.js') }}"></script>
{{-- non srtdash --}}
<!-- AdminLTE App -->
