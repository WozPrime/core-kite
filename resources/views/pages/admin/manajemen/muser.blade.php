                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="privilege" id="privilege" class="form-control">
                                                                            <option value=""
                                                                                @if ($user->privilege == '' && $user->role != 'admin') selected @endif
                                                                                >Tidak Ada Hak Akses </option>
                                                                            <option value="1"
                                                                                @if ($user->privilege == 1) selected @endif
                                                                                >Super Admin </option>
                                                                            <option value=""
                                                                                @if ($user->privilege == '' && $user->role == 'admin') selected @endif>
                                                                                Project Manager</option>
                                                                            <option value="2"
                                                                                @if ($user->privilege == 2) selected @endif>
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="role" id="role" class="form-control" required>
                                    <option selected disabled hidden>Pilih Role
                                    </option>
